...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_State_Roll);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Idle_Wall_Vault_On);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Idle_Wall_Vault_Over);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Wall_Vault_On);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Wall_Vault_Over);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Wall_Vault_Under_Bar);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Wall_Vault_Over_180_Shimmy);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Tic_Tac_L_Over_Front_Wall);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Tic_Tac_R_Over_Front_Wall);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Tic_Tac_L_On_Front_Wall_To_Idle);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Tic_Tac_L_On_Front_Wall_To_Run);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Tic_Tac_R_On_Front_Wall_To_Idle);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Tic_Tac_R_On_Front_Wall_To_Run);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Tic_Tac_L_Over_Right_Wall);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Walking_Step_L_On);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Walking_Step_R_On);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Step_L_On);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Step_R_On);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Walking_Step_L_On_Off_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Walking_Step_R_On_Off_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Step_L_On_Off_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Step_R_On_Off_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Walking_Step_L_On_Off_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Walking_Step_R_On_Off_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Step_L_On_Off_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Step_R_On_Off_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Idle_Vault_L_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Idle_Vault_R_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Jump_Step_On_L);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Running_Jump_Step_On_R);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Medium_Vault_L_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Medium_Vault_R_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_High_Vault_L_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_High_Vault_R_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Long_Vault_L_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Long_Vault_R_To_Ground);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Idle_Vault_L_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Idle_Vault_R_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Medium_Vault_L_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Medium_Vault_R_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_High_Vault_L_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_High_Vault_R_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Long_Vault_L_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Long_Vault_R_To_Airborne);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Roll_Forward_L);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Roll_Forward_R);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Dive_Roll_Forward_L);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Action_Dive_Roll_Forward_R);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_L_Vault_On);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_R_Jump_On);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_R_Jump_On_Run);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_R_Vault_On);


UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_L_Jump_Over);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_L_Reverse_Over);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_L_Speed_Over);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_R_Jump_Over);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_R_Reverse_Over);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_R_Speed_Over);


UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Parkour_Tic_Tac_L_Jump_Side_Over);
